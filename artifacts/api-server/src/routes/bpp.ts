...
const DEFAULT_FUNDS = [
  {
    ...
    slug: "rent-mortgage",
    description: "Helps qualifying Pro Members offset housing costs.",
    ...
    isActive: true,
    displayOrder: 1,
    memberFacingCopy: "Help your group reach 15,000 GV while maintaining 100 PV to qualify for up to $1,500 toward your rent or mortgage.",
    disclaimerText: "Fund cap and requirements may be changed at company discretion.",
  },
  {
    name: "Car Fund",
    slug: "car",
    description: "Helps qualifying Pro Members offset vehicle payments.",
    payoutMode: "percentage" as const,
    payoutPercentage: "8",
    flatAmount: "0",
    gvRequirement: "8000",
    ...
    isActive: true,
    displayOrder: 2,
    memberFacingCopy: "Reach 8,000 GV with 100 PV to qualify for up to $600 toward your car payment.",
    disclaimerText: "Fund cap and requirements may be changed at company discretion.",
  },
  {
    name: "Utilities Fund",
    slug: "utilities",
    description: "Helps qualifying Pro Members offset utility bills.",
    payoutMode: "percentage" as const,
    payoutPercentage: "6",
    flatAmount: "0",
    gvRequirement: "6000",
    ...
    isActive: true,
    displayOrder: 3,
    memberFacingCopy: "Reach 6,000 GV with 100 PV to qualify for up to $450 toward your utility bills.",
    disclaimerText: "Fund cap and requirements may be changed at company discretion.",
  },
  {
    name: "Medical Fund",
    slug: "medical",
    description: "Helps qualifying Pro Members offset medical expenses.",
    payoutMode: "percentage" as const,
    payoutPercentage: "5",
    flatAmount: "0",
    gvRequirement: "5000",
    ...
    isActive: true,
    displayOrder: 4,
    memberFacingCopy: "Reach 5,000 GV with 100 PV to qualify for up to $350 toward medical expenses.",
    disclaimerText: "Fund cap and requirements may be changed at company discretion.",
  },
  {
    name: "Phone / Internet Fund",
    slug: "phone-internet",
    description: "Helps qualifying Pro Members offset phone and internet bills.",
    payoutMode: "percentage" as const,
    payoutPercentage: "4",
    flatAmount: "0",
    gvRequirement: "3000",
    ...
    isActive: true,
    displayOrder: 5,
    memberFacingCopy: "Reach 3,000 GV with 100 PV to qualify for up to $185 toward your phone and internet bills.",
    disclaimerText: "Fund cap and requirements may be changed at company discretion.",
  },
];
